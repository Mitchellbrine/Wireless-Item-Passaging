...
public class ConfigUtils {
    ...
    public static boolean useHardcoreRecipes;
    ...
    public static void init(Configuration config) {
        ...
        useHardcoreRecipes = config.getBoolean("Use Hard Mode Recipes","recipe",false,"Make certain recipes require more to craft");
