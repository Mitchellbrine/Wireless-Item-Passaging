    ...
    public void renderTileEntityAt(TileEntity entity, double par2, double par3, double par4, float par5) {
        if (entity instanceof TileEntityConduit) {
            ...
            if (te.getInventoryType() != null && te.getInventoryType().getTextureName() != null) {
                ...
                tesselator.draw();
                tesselator.addVertexWithUV(entity.xCoord,entity.yCoord,entity.zCoord,0,0);
                tesselator.addVertex(0, 0, 0);
                tesselator.addVertex(0, 1, 0);
                tesselator.addVertex(1, 1, 0);
                tesselator.addVertex(1, 0, 0); */
                GL11.glPopMatrix();
            }
        }
    }
